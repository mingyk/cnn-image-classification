...
void test_im2col()
{
    ...
    // tensor m1 = tensor_vmake(3, 1, 4, 4);
    // m1.data[0] = 1; m1.data[1] = 2; m1.data[2] = 3; m1.data[3] = 4;
    // m1.data[4] = 5; m1.data[5] = 6; m1.data[6] = 7; m1.data[7] = 8;
    // m1.data[8] = 9; m1.data[9] = 10; m1.data[10] = 11; m1.data[11] = 12;
    // m1.data[12] = 13; m1.data[13] = 14; m1.data[14] = 15; m1.data[15] = 16;
    // tensor col = im2col(m1, 3, 3, 3, 1);
    // tensor m2 = tensor_vmake(2, 9, 4);
    // m2.data[0] = 0; m2.data[1] = 0; m2.data[2] = 0; m2.data[3] = 11;
    // m2.data[4] = 0; m2.data[5] = 0; m2.data[6] = 9; m2.data[7] = 12;
    // m2.data[8] = 0; m2.data[9] = 0; m2.data[10] = 10; m2.data[11] = 0;
    // m2.data[12] = 0; m2.data[13] = 3; m2.data[14] = 0; m2.data[15] = 15;
    // m2.data[16] = 1; m2.data[17] = 4; m2.data[18] = 13; m2.data[19] = 16;
    // m2.data[20] = 2; m2.data[21] = 0; m2.data[22] = 14; m2.data[23] = 0;
    // m2.data[24] = 0; m2.data[25] = 7; m2.data[26] = 0; m2.data[27] = 0;
    // m2.data[28] = 5; m2.data[29] = 8; m2.data[30] = 0; m2.data[31] = 0;
    // m2.data[32] = 6; m2.data[33] = 0; m2.data[34] = 0; m2.data[35] = 0;
    // TEST(same_tensor(m2,   col));
    // tensor_free(col);
    // tensor_free(m1);
    // tensor_free(m2);
