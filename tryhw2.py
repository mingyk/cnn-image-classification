...
# TODO: Your answer
# When using batch norm, the accuracy went up by 12%. Without it, it was ~40% for both training and test. It makes the model converge quicker than the one without it. Frankly not sure if there are any effects of LR from batchnorms since I was not able to see any major changes.
